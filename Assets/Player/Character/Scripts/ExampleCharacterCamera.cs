...
namespace KinematicCharacterController.Examples
{
    public class ExampleCharacterCamera : MonoBehaviour
    {
        ...
        private float CrouchOffsetCheck() {
            return _characterController._isCrouched ? CrouchOffset : 0;
        }
        ...
        public void UpdateWithInput(float deltaTime, float zoomInput, Vector3 rotationInput)
        {
            if (FollowTransform)
            {
                ...
                targetPosition += Transform.up * (FollowPointFraming.y - CrouchOffsetCheck());
